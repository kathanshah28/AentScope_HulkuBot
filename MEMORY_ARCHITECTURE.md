...
This document details the newly implemented Hybrid Memory Architecture for the HulkuBot AI Agent. The architecture consists of three distinct layers: Working Memory, Semantic Memory, and Episodic Memory.
...
## 1. Working Memory (Real-Time State Injection)
...
## 2. Semantic Memory (Rules & Constraints)
...
## 3. Episodic Memory (Experience via RAG)
